...
{ 
    /// <summary>
    /// An array of document IDs to track
    /// </summary>
    [DataContract]
    public partial class DocumentQuery : IEquatable<DocumentQuery>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DocumentQuery)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (DocumentIds != null)
                    hashCode = hashCode * 59 + DocumentIds.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(DocumentQuery left, DocumentQuery right)
        {
